...
const Work = () => (
  <Layout title="mode.tokyo">
    <Container>
      ...
      <SkillImage src="/images/works/modetokyo_eyecatch.png" alt="mode.tokyo" />
      <SimpleGrid columns={2} gap={2}>
        <SkillImage src="/images/works/modetokyo_01.png" alt="mode.tokyo" />
        <SkillImage src="/images/works/modetokyo_02.png" alt="mode.tokyo" />
      </SimpleGrid>
      <SkillImage src="/images/works/modetokyo_03.jpg" alt="mode.tokyo" />
    </Container>
  </Layout>
)
